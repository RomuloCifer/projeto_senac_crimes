...
export const CASES = [
  ...
  },
  {
    ...
    images: ['/cases/castelinho-apa/1.jpg', '/cases/castelinho-apa/2.jpg'],
  ...
  },
  {
    ...
    images: ['/cases/operacao-prato/1.jpg', '/cases/operacao-prato/2.jpg'],
  ...
  },
  {
    ...
    images: ['/cases/arco-teles/1.jpg', '/cases/arco-teles/2.jpg'],
  ...
  },
  {
    ...
    images: ['/cases/opala-preto/1.jpg', '/cases/opala-preto/2.jpg'],
  ...
  },
  {
    ...
    images: ['/cases/loira-banheiro/1.jpg', '/cases/loira-banheiro/2.jpg'],
  ...
  },
  {
    ...
    images: ['/cases/corpo-seco/1.jpg', '/cases/corpo-seco/2.jpg'],
  ...
  },
  {
    ...
    images: ['/cases/inst-penal-candido/1.jpg', '/cases/inst-penal-candido/2.jpg'],
  ...
  },
  {
    ...
    images: ['/cases/sete-alem/1.jpg', '/cases/sete-alem/2.jpeg'],
...

  {
    ...
    imageUrl: '/cases/cemiterio-Consolação/1.jpg',
    ...
    images: ['/cases/cemiterio-Consolação/1.jpg', '/cases/cemiterio-Consolação/2.jpg'],
...

  {
    ...
    latitude: -22.5050,
    longitude: -43.1780,
    imageUrl: '/cases/casa-morte-petropolis/1.jpg',
    ...
    images: ['/cases/casa-morte-petropolis/1.jpg'],
  ...
  {
    id: 'chico-mendes',
    title: 'Assassinato de Chico Mendes',
    category: 'crime',
    city: 'Xapuri',
    state: 'AC',
    year: '1988',
    latitude: -10.6514,
    longitude: -68.5044,
    imageUrl: '/cases/chico-mendes/1.jpg',
    description: 'Em 22 de dezembro de 1988, o seringueiro, sindicalista e ativista ambiental Chico Mendes foi morto a tiros nos fundos de sua casa. Ele vinha recebendo ameaças devido à sua luta contra o desmatamento ilegal promovido por fazendeiros da região. A humilde casa de madeira onde ele morava é hoje um bem tombado pelo IPHAN.',
    curiosity: 'O crime transformou Chico Mendes em símbolo global da defesa da Amazônia.',
    canVisit: '✅ Sim — bem tombado (visitação controlada).',
    images: ['/cases/chico-mendes/1.jpg', '/cases/chico-mendes/2.jpg'],
  ...
  {
    id: 'meninos-emaculados-altamira',
    title: 'Caso dos Meninos Emaculados de Altamira',
    category: 'crime',
    city: 'Altamira',
    state: 'PA',
    year: '1989-1993',
    latitude: -3.2031,
    longitude: -52.2064,
    imageUrl: '/cases/meninos-emaculados/1.jpg',
    description: 'Entre 1989 e 1993, uma série de crimes bárbaros aterrorizou Altamira: meninos foram sequestrados, torturados e mutilados. Ao menos 6 crianças foram mortas e outras desapareceram. Investigações posteriores ligaram parte dos crimes a um serial killer condenado no Maranhão.',
    curiosity: 'Caso complexo com várias teorias envolvendo seitas e redes criminosas.',
    canVisit: '⚠️ Limitado — local sensível e de memória traumática.',
    images: ['/cases/meninos-emaculados/1.jpg'],
  ...
  {
    id: 'matinta-perera',
    title: 'Matinta Perera (assombrações do interior)',
    category: 'lenda',
    city: 'Região Amazônica',
    state: 'BR',
    year: 'Tradição popular',
    latitude: -0.7167,
    longitude: -48.5134,
    imageUrl: '/cases/matinta-perera/1.jpg',
    description: 'Lenda regional sobre uma velha bruxa que se transforma em um pássaro sombrio à noite. Moradores de áreas ribeirinhas relatam assobios estridentes e avistamentos. A lenda é tratada com respeito e temor por muitos.',
    curiosity: 'A Matinta Perera é uma figura folclórica conhecida em várias comunidades amazônicas.',
    canVisit: '✅ Sim — manifestações culturais e locais rurais.',
    images: ['/cases/matinta-perera/1.jpg', '/cases/matinta-perera/2.jpg'],
  ...
  {
    id: 'o-teatro-dos-relogios-que-riem',
    title: 'O Teatro dos Relógios que Ri',
    category: 'lenda',
    city: 'Lugar Nenhum',
    state: 'BR',
    year: 'Eterno',
    latitude: -15.0000,
    longitude: -47.0000,
    imageUrl: '/cases/o-teatro-dos-relogios-que-riem/1.jpg',
    description: 'Um teatro invisível que aparece apenas quando nenhum morador está olhando para a lua. Dentro dele os relógios não contam horas — eles contam segredos. Quem assistir a uma peça jura que ouviu os ponteiros sussurrando memórias alheias e, às vezes, gargalhadas longas que fazem as luminárias derreterem lentamente em forma de borboletas metálicas. Visitantes relatam a sensação de ter esquecido algo essencial ao sair; ninguém consegue lembrar o quê.',
    curiosity: 'Dizem que, se você deixar um bilhete no balcão do teatro e voltar no dia seguinte, o bilhete terá escrito algo que você sempre quis ouvir, mas não sabia pedir.',
    canVisit: '❌ Não — aparece e some sem avisar.',
    images: ['/cases/o-teatro-dos-relogios-que-riem/1.jpg'],
  },

  {
    ...
    latitude: -23.7770,
    longitude: -46.3000,
    imageUrl: '/cases/trem-Paranapiacaba/1.jpg',
    ...
    images: ['/cases/trem-Paranapiacaba/1.jpg', '/cases/trem-Paranapiacaba/2.jpg'],
...

  {
    ...
    latitude: -22.9698,
    longitude: -43.1553,
    imageUrl: '/cases/naufragio-Bateau/1.jpg',
    ...
    images: ['/cases/naufragio-Bateau/1.jpg', '/cases/naufragio-Bateau/2.jpg'],
...

  {
    ...
    latitude: -23.5446,
    longitude: -46.6330,
    imageUrl: '/cases/edificio-wil/1.jpg',
    ...
    images: ['/cases/edificio-wil/1.jpg', '/cases/edificio-wil/2.jpg'],
...

  {
    ...
    latitude: -21.5514,
    longitude: -45.4302,
    imageUrl: '/cases/et_varginha/1.jpg',
    ...
    images: ['/cases/et_varginha/1.jpg', '/cases/et_varginha/2.jpg'],
...

  {
    ...
    images: ['/cases/escola-base/1.jpg', '/cases/escola-base/2.jpg'],
...

  {
    ...
    latitude: -22.8976,
    longitude: -43.1700,
    imageUrl: '/cases/ilha-cobras/1.jpg',
    ...
    images: ['/cases/ilha-cobras/1.jpg', '/cases/ilha-cobras/2.jpg'],
